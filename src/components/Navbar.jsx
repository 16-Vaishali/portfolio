...
const Navbar = () => {
 ...
 <nav>
      ...
      <nav className='flex items-center justify-center flex-wrap'>
        <motion.a href={'https://www.linkedin.com/in/vaishali-b-032740237'} target={"_blank"} whileHover={{y:-2}} className='w-8 mr-3'
        whileTap={{scale:0.9}}><FaLinkedin fontSize={'35'} color='#2390de'/></motion.a>
        <motion.a href={'https://github.com/16-vaishali'} target={"_blank"} whileHover={{y:-2}} whileTap={{scale:0.9}} 
