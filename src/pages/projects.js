...
import cmdPic from '../../public/images/cmd.jpg'
...
const projects = () => {
  return (
    <>
    <Head>
      <title>Vaishh | Projects page</title>
      </Head>
      <main className='w-full mb-16 flex flex-col items-center justify-center'>
        <Layout className={'pt-16'}>
            <AnimatedText text={"Projects makes a dev Perfect!"} classname='!text-6xl mb-16'/>
  ...
  type={"Major project"}
  git={"https://github.com/16-Vaishali/codeQuest"}
  img={codingPic}
/>

                </div>
                <div className='col-span-6'>
                    <Minor title="Interactive CLI Tool"
                    link={"https://www.npmjs.com/package/package-hub"} type={"Minor project"} git={"https://github.com/16-Vaishali/package-hub"} img={cmdPic}/>
                    
                    </div>
                    <div className='col-span-6'>
                  
                    <Minor title="E-Commerce Website"
                    link={"/"} type={"Minor project"} git={"https://github.com/16-Vaishali/eCommerce"} img={ecomPic}/>
                    </div>
